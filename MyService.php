...
$server->wsdl->addComplexType('ListDiscountsIncomeEmployees',
    ...
    '',
		...
		'fecha_ultimo_pago' => array('name' => 'fecha_ultimo_pago', 'type' => 'xsd:string'),
		'cantidad_pago' => array('name' => 'cantidad_pago', 'type' => 'xsd:int'),
		'cod_descuento_ingreso' => array('name' => 'cod_descuento_ingreso', 'type' => 'xsd:string'),
		'fecha_creacion' => array('name' => 'fecha_creacion', 'type' => 'xsd:string'),
       	'id_usuario' => array('name' => 'id_usuario', 'type' => 'xsd:int')
       )
...
$server->wsdl->addComplexType('ViewEmployees',
    'complexType',
    'struct',
    'all',
    '',
...
$server->wsdl->addComplexType('return_ViewEmployees',
    'complexType',
    'array',
    'all',
    'SOAP-ENC:Array',
    array(),
    array(
    array('ref'=>'SOAP-ENC:arrayType','wsdl:arrayType'=>'tns:ViewEmployees[]')
    ),
    'tns:ViewEmployees'
    );
...
$server->register('AddDiscountsIncomeEmployee',
    array('numero_cliente' =>'xsd:string','numero_cuenta' => 'xsd:string','numero_empleado' => 'xsd:string',
		...
		'referencia' =>'xsd:string', 'id_periodo' => 'xsd:int','fecha_ultimo_pago' =>'xsd:string', 'cantidad_pago' => 'xsd:int','id_usuario' => 'xsd:int'),
    array('return' => 'tns:return_GetMsg'),
    $ns,
...
$server->register('AddDiscountsIncomeEmployeeDetail',
    array('id_empleado' => 'xsd:int','cod1' => 'xsd:string','cod2' => 'xsd:string','cod3' => 'xsd:string','cod4' => 'xsd:string','cod5' =>'xsd:string','cod6' =>'xsd:string',
	'monto1' => 'xsd:string','monto2' => 'xsd:string','monto3' => 'xsd:string','monto4' => 'xsd:string','monto5' =>'xsd:string','monto6' =>'xsd:string',
	'pendiente1' => 'xsd:string','pendiente2' => 'xsd:string','pendiente3' => 'xsd:string','pendiente4' => 'xsd:string','pendiente5' =>'xsd:string','pendiente6' =>'xsd:string',
	'estado' =>'xsd:int','id_periodo' => 'xsd:int','id_empresa' => 'xsd:int','id_usuario' => 'xsd:int'),
    array('return' => 'tns:return_GetMsg'),
    $ns,
    $ns.'#AddDiscountsIncomeEmployeeDetail',
    'rpc',
...
$server->register('AddEmployeeRecordTransaction',
    array('id_empleado' =>'xsd:int', 'id_empresa' =>'xsd:int','id_periodo' => 'xsd:int',
...
$server->register('AddReceiptsEmployees',
    array('id_empleado' => 'xsd:int','numero_empleado' => 'xsd:string','id_periodo' =>  'xsd:int','id_seccion' =>  'xsd:int','nombre_seccion' => 'xsd:string',
						'nombre_departamento' =>'xsd:string','nombre_empleado' => 'xsd:string','apellido_empleado' => 'xsd:string','cedula_empleado' => 'xsd:string','id_empresa' =>  'xsd:int',
						'nombre_empresa' => 'xsd:string','rataxhora' => 'xsd:string','claveir' => 'xsd:string','numero_comprobante' => 'xsd:string','numero_cuenta' => 'xsd:string',
						'id_tipo_cuenta' =>  'xsd:int','id_banco' =>  'xsd:int','total_ingreso' => 'xsd:string','total_descuento' => 'xsd:string'),	
    array('return' => 'tns:return_GetMsg'),
    $ns,
...
$server->register('EditEmployeeRecordTransactionByid',
    array('id_registro_transaccion_empleado' =>'xsd:int','id_empleado' =>'xsd:int', 'id_empresa' =>'xsd:int','id_periodo' => 'xsd:int',
		 'horas_regular' =>'xsd:string', 'horas_domingo' => 'xsd:string', 
		  'horas_feriado' =>'xsd:string', 'horas_compensatorio' => 'xsd:string',
		  'horas_extra1' => 'xsd:string','horas_extra2' => 'xsd:string', 'horas_extra3' => 'xsd:string', 'horas_extra4' => 'xsd:string', 'horas_extra5' => 'xsd:string',
		  'horas_extra6' =>'xsd:string','horas_extra7' => 'xsd:string', 'horas_extra8' => 'xsd:string', 'horas_extra9' => 'xsd:string', 'horas_extra10' => 'xsd:string',
...
//Register GetEmployeesRecordsTransactionsByCompany function
$server->register('GetEmployeesRecordsTransactionsByCompany',
    array('id_empresa' => 'xsd:int','id_periodo' => 'xsd:int'),	
    array('return' => 'tns:return_GetMsg'),
    $ns,
    $ns.'#GetEmployeesRecordsTransactionsByCompany',
    'rpc',
    'encoded',
    ''
    );
...
//Register GetEmployeesByid function 
$server->register('GetEmployeesByid',
     array('id_empleado' => 'xsd:int'),		
    array('return' => 'tns:return_ViewEmployees'),
    $ns,
    $ns.'#GetEmployeesByid',
    'rpc',
    'encoded',
...
function AddDiscountsIncomeEmployee($numero_cliente, $numero_cuenta, $numero_empleado,$id_empleado, 
									...
									$prioridad,$tipo,$frecuencia,$monto_urgente, $monto_original,$monto_pendiente,$estado,$referencia,$id_periodo,$fecha_ultimo_pago,$cantidad_pago,$id_usuario) {
	...
	if ($connect) {
		   ...
		   referencia='$referencia',id_periodo='$id_periodo',fecha_ultimo_pago='$fecha_ultimo_pago',cantidad_pago='$cantidad_pago',id_usuario='$id_usuario'");
           $result[] = array("msg" => "OK","id" => mysqli_insert_id($connect));
	}
	else
	{
...
function AddDiscountsIncomeEmployeeDetail($id_empleado,$cod1,$cod2,$cod3,$cod4,$cod5,$cod6,$monto1,$monto2,$monto3,$monto4,$monto5,$monto6,
$pendiente1,$pendiente2,$pendiente3,$pendiente4,$pendiente5,$pendiente6,$estado,$id_periodo,$id_empresa,$id_usuario) {

    $connect = mysqli_connect("localhost", "UserCaisa", "UserCaisa", "planillas");
	$result =array();
	if ($connect) {
		
		   mysqli_query($connect,"INSERT INTO descuentos_ingresos_empleados_detalles SET id_empleado='$id_empleado',cod1='$cod1',cod2='$cod2',cod3='$cod3',cod4='$cod4',cod5='$cod5',cod6='$cod6',
...
function AddEmployeeRecordTransaction($id_empleado, $id_empresa, $id_periodo,$horas_regular, $horas_domingo,$horas_feriado, $horas_compensatorio,
	...
	if ($connect) {
		   ...
		   mysqli_query($connect,"INSERT INTO registros_transacciones_empleados SET id_empleado='$id_empleado', id_empresa='$id_empresa',id_periodo='$id_periodo',
...
function AddReceiptsEmployees($id_empleado,$numero_empleado,$id_periodo,$id_seccion,$nombre_seccion,
$nombre_departamento,$nombre_empleado,$apellido_empleado,$cedula_empleado,$id_empresa,
$nombre_empresa,$rataxhora,$claveir,$numero_comprobante,$numero_cuenta,
$id_tipo_cuenta,$id_banco,$total_ingreso,$total_descuento) {
	...
	if ($connect) {
		   ...
		   mysqli_query($connect,"INSERT INTO comprobantes_empleados SET id_empleado='$id_empleado', numero_empleado='$numero_empleado', id_periodo='$id_periodo', 
		   id_seccion='$id_seccion',nombre_seccion='$nombre_seccion',nombre_departamento='$nombre_departamento',nombre_empleado='$nombre_empleado',apellido_empleado='$apellido_empleado',cedula_empleado='$cedula_empleado',
		   id_empresa='$id_empresa',nombre_empresa='$nombre_empresa',rataxhora='$rataxhora',claveir='$claveir',numero_comprobante='$numero_comprobante',numero_cuenta='$numero_cuenta',id_tipo_cuenta='$id_tipo_cuenta',
		   id_banco='$id_banco',total_ingreso='$total_ingreso',total_descuento='$total_descuento'");
           $result[] = array("msg" => "OK","id" => mysqli_insert_id($connect));
	}
	else
	{
...
function EditEmployeeRecordTransactionByid($id_registro_transaccion_empleado,$id_empleado,$id_empresa, $id_periodo,$horas_regular, $horas_domingo,$horas_feriado, $horas_compensatorio,
									  $horas_extra1,$horas_extra2, $horas_extra3, $horas_extra4, $horas_extra5,$horas_extra6,$horas_extra7, 
									  $horas_extra8, $horas_extra9, $horas_extra10,$factor_reg,$factor_dom, $factor_fer, $factor_com, 
									  $factor1, $factor2, $factor3, $factor4, $factor5,$factor6, $factor7, $factor8, $factor9, $factor10,
									  $horas_enferm, $horas_ajuste, $horas_ausen, $horas_certmedic, $adelanto_vacaciones) {
	...
	if ($connect) {
		   ...
		   mysqli_query($connect,"UPDATE registros_transacciones_empleados SET id_empleado='$id_empleado',id_empresa='$id_empresa', id_periodo='$id_periodo',
					horas_regular='$horas_regular', horas_domingo='$horas_domingo', 
					horas_feriado='$horas_feriado', horas_compensatorio='$horas_compensatorio',
					horas_extra1='$horas_extra1', horas_extra2='$horas_extra2', horas_extra3='$horas_extra3', horas_extra4='$horas_extra4', horas_extra5='$horas_extra5',
					horas_extra6='$horas_extra6', horas_extra7='$horas_extra7', horas_extra8='$horas_extra8', horas_extra9='$horas_extra9', horas_extra10='$horas_extra10',
...
function GetDiscountsIncomeEmployeeByid($id_descuento_ingreso_empleado) {
	...
	if ($connect) {
		 ...
		 $sql="SELECT e.id_descuento_ingreso_empleado, e.numero_cliente, e.numero_cuenta, e.id_empleado, e.numero_empleado, 
		 e.id_descuento_ingreso, e.monto_mes, e.monto_periodo, e.afecta_diciembre, e.prioridad, e.tipo, e.frecuencia, 
		 e.monto_urgente, e.monto_original, e.monto_pendiente, e.estado, e.referencia, e.id_periodo, e.fecha_ultimo_pago, e.cantidad_pago, d.cod_descuento_ingreso, e.fecha_creacion, e.id_usuario 
		 FROM descuentos_ingresos_empleados e,descuentos_ingresos d
		 WHERE e.id_descuento_ingreso=d.id_descuento_ingreso AND e.id_descuento_ingreso_empleado='$id_descuento_ingreso_empleado'";
		 $qur=mysqli_query($connect,$sql);
			...
			if(mysqli_num_rows($qur))  {
               while($row = mysqli_fetch_assoc($qur)) {
					  ...
					  'monto_urgente' => $monto_urgente, 'monto_original' => $monto_original, 'monto_pendiente' => $monto_pendiente,  'estado' => $estado, 
					  'referencia' => $referencia, 'id_periodo' => $id_periodo, 'fecha_ultimo_pago'=>$fecha_ultimo_pago, 'cantidad_pago'=>$cantidad_pago, 'cod_descuento_ingreso'=>$cod_descuento_ingreso, 'fecha_creacion' => $fecha_creacion,'id_usuario'=> $id_usuario); 
				}
			}
			else
			{
					 $result[] = array('id_descuento_ingreso_empleado' => null, 'numero_cliente' => null, 
					  ...
					  'referencia' => null, 'id_periodo' => null, 'fecha_ultimo_pago'=>null, 'cantidad_pago'=>null, 'cod_descuento_ingreso'=>null,'fecha_creacion' => null,'id_usuario'=> null); 
			}
...
function GetUserByName($nombre_usuario,$pwd) {
	...
	if ($connect) {
		 ...
		 $sql="SELECT id_usuario, id_rol, id_estado_usuario, nombre_usuario, pwd, fecha_creacion 
			   FROM usuarios
		 ...
		 $qur=mysqli_query($connect,$sql);
			...
			if(mysqli_num_rows($qur))  {
               while($row = mysqli_fetch_assoc($qur)) {
					  extract($row);
					  $result[] = array('id_usuario' => $id_usuario,'id_rol' => $id_rol,'id_estado_usuario' => $id_estado_usuario,'nombre_usuario' => $nombre_usuario, 'pwd' => $pwd, 'fecha_creacion'=> $fecha_creacion); 
			...
			{
				 $result[] = array('id_usuario' => null,'id_rol' => null,'id_estado_usuario' => null,'nombre_usuario' => null, 'pwd' => null,'fecha_creacion'=>null); 
			}
...
function GetAllDiscountsIncomeEmployeeByidEmployee($id_empleado) {
	...
	if ($connect) {
		 ...
		 e.monto_urgente, e.monto_original, e.monto_pendiente, e.estado, e.referencia, e.id_periodo, e.fecha_ultimo_pago, e.cantidad_pago, d.cod_descuento_ingreso, e.fecha_creacion, e.id_usuario 
		 FROM descuentos_ingresos_empleados e,descuentos_ingresos d
		 WHERE e.id_descuento_ingreso=d.id_descuento_ingreso AND e.id_empleado='$id_empleado'";
		 $qur=mysqli_query($connect,$sql);

			if(mysqli_num_rows($qur))  {
               while($row = mysqli_fetch_assoc($qur)) {
					  extract($row);
					  $result[] = array('id_descuento_ingreso_empleado' => $id_descuento_ingreso_empleado, 
					  'numero_cliente' => $numero_cliente,'numero_cuenta' => $numero_cuenta, 'id_empleado' => $id_empleado,
					  'numero_empleado' => $numero_empleado, 'id_descuento_ingreso' => $id_descuento_ingreso, 
					  'monto_mes' => $monto_mes,'monto_periodo' => $monto_periodo, 'afecta_diciembre' => $afecta_diciembre,
					  'prioridad' => $prioridad, 'tipo' => $tipo,'frecuencia' => $frecuencia,
					  'monto_urgente' => $monto_urgente, 'monto_original' => $monto_original, 'monto_pendiente' => $monto_pendiente,  
					  'estado' => $estado,'referencia' => $referencia,'id_periodo' => $id_periodo,'fecha_ultimo_pago'=>$fecha_ultimo_pago, 'cantidad_pago'=>$cantidad_pago,'cod_descuento_ingreso'=>$cod_descuento_ingreso,'fecha_creacion' => $fecha_creacion,'id_usuario'=> $id_usuario); 
				}
			}
			else
			{
					$result[] = array('id_descuento_ingreso_empleado' => null, 'numero_cliente' => null, 
					  ...
					  'monto_mes' => null,'monto_periodo' => null, 'afecta_diciembre' => null,
					  'prioridad' => null, 'tipo' => null,'frecuencia' =>null,
					  'monto_urgente' =>null, 'monto_original' => null, 'monto_pendiente' => null,  
					  'estado' => null,'referencia' => null,'id_periodo' => null,'fecha_ultimo_pago'=>null, 'cantidad_pago'=>null,'cod_descuento_ingreso'=>null,'fecha_creacion' => null,'id_usuario'=> null); 
			}
...
function GetReceiptEmployeeByCompany($id_empresa,$id_periodo) {
	...
	if ($connect) {
				  ...
				  $sql="SELECT * FROM comprobantes_empleados WHERE id_empresa='$id_empresa' AND id_periodo='$id_periodo'";
			 $qur=mysqli_num_rows(mysqli_query($connect,$sql));
			if($qur>0) {
				$result[] = array("msg" => "OK","id" => 0);	
			}
			else
...
//Body GetEmployeesRecordsTransactionsByCompany function 
function GetEmployeesRecordsTransactionsByCompany($id_empresa,$id_periodo) {
	...
	if ($connect) {
				  ...
				  //$sql="SELECT * FROM talonarios_empleados WHERE id_empresa='$id_empresa' AND id_periodo='$id_periodo'";
				  $sql="SELECT * FROM registros_transacciones_empleados WHERE id_empresa='$id_empresa' AND id_periodo='$id_periodo'";
		 $qur=mysqli_num_rows(mysqli_query($connect,$sql));
...
function GetEmployeesRecordsTransactionsByid($id_empleado,$id_periodo) {

    $connect = mysqli_connect("localhost", "UserCaisa", "UserCaisa", "planillas");
	$result =array();
	if ($connect) {
		
			 $sql="SELECT id_registro_transaccion_empleado, id_empleado, id_empresa,id_periodo,
		 ...
		 $qur=mysqli_query($connect,$sql);
			...
			if(mysqli_num_rows($qur))  {
               while($row = mysqli_fetch_assoc($qur)) {
					  extract($row);
					 $result[] = array('id_registro_transaccion_empleado' => $id_registro_transaccion_empleado, 'id_empleado' => $id_empleado, 'id_empresa' => $id_empresa,'id_periodo' => $id_periodo,
					 'horas_regular' => $horas_regular, 'horas_domingo' => $horas_domingo, 
					  'horas_feriado' => $horas_feriado, 'horas_compensatorio' => $horas_compensatorio,
					  'horas_extra1' => $horas_extra1,'horas_extra2' => $horas_extra2, 'horas_extra3' => $horas_extra3, 'horas_extra4' => $horas_extra4, 'horas_extra5' => $horas_extra5,
					  'horas_extra6' => $horas_extra6,'horas_extra7' => $horas_extra7, 'horas_extra8' => $horas_extra8, 'horas_extra9' => $horas_extra9, 'horas_extra10' => $horas_extra10,
			...
			{
					$result[] = array('id_registro_transaccion_empleado' =>null, 'id_empleado' => null,  'id_empresa' => null,'id_periodo' => null,
...
//Body GetEmployeesByid function 
function GetEmployeesByid($id_empleado) {

    $connect = mysqli_connect("localhost", "UserCaisa", "UserCaisa", "planillas");
	$result =array();
	if ($connect) {
		
				$sql="SELECT e.id_empleado, e.numero_empleado, s.id_seccion, s.nombre_seccion, d.nombre_departamento, e.nombre, e.apellido, e.cedula, em.id_empresa, em.nombre_empresa, e.rata_x_hora, e.clave_renta, c.numero_cuenta, c.id_tipo_cuenta, c.id_banco
						FROM empleados e, secciones s, departamentos d, empresas em, cuentas_banco_empleados c
						WHERE e.id_empleado = c.id_empleado
						AND e.id_seccion = s.id_seccion
						AND s.id_departamento = d.id_departamento
		 ...
		 $qur=mysqli_query($connect,$sql);
			...
			if(mysqli_num_rows($qur))  {
               while($row = mysqli_fetch_assoc($qur)) {
					  extract($row);
					  $result[] = array('id_empleado' =>$id_empleado,'numero_empleado'=>$numero_empleado,'id_seccion'=>$id_seccion,'nombre_seccion'=>$nombre_seccion,
										'nombre_departamento'=>$nombre_departamento,'nombre'=>$nombre,'apellido'=>$apellido,'cedula'=>$cedula,
										'id_empresa'=>$id_empresa,'nombre_empresa'=>$nombre_empresa,'rata_x_hora'=>$rata_x_hora,'clave_renta'=>$clave_renta,
										'numero_cuenta'=>$numero_cuenta,'id_tipo_cuenta'=>$id_tipo_cuenta,'id_banco'=>$id_banco); 
				}
			}
			 else
			{
					 $result[] =  array('id_empleado' =>null,'numero_empleado'=>null,'id_seccion'=>null,'nombre_seccion'=>null,
										'nombre_departamento'=>null,'nombre'=>null,'apellido'=>null,'cedula'=>null,
										'id_empresa'=>null,'nombre_empresa'=>null,'rata_x_hora'=>null,'clave_renta'=>null,
										'numero_cuenta'=>null,'id_tipo_cuenta'=>null,'id_banco'=>null); 
			}
    }
    mysqli_close($connect);
    return $result;
